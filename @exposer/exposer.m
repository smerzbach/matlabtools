...
classdef exposer < handle
    properties
        ...
        nc = 1;
        button_size = [-1, 20]
        flex = false; % use GridFlex so UI elements can be resized
    ...
    methods
        ...
        function ui_init(obj)
            ...
            for ii = 1 : numel(obj.props)
                ...
                if any(strcmpi(obj.controls{ii}, {'slider', 'sliderEdit'}))
        ...
        function update(obj, prop)
            ...
            elseif any(strcmpi(obj.controls{ii}, {'checkbox', 'sliderEdit'}))
